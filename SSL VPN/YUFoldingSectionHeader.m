...
-(CAShapeLayer *)sepertorLine
{
    if (!_sepertorLine) {
        ...
        _sepertorLine.strokeColor =getColor(@"EAEAEA").CGColor;
...
//    设置 header 左侧边框
    ...
    UIView * borderView = [[UIView alloc]initWithFrame:CGRectMake(0, -2, 3, self.frame.size.height)];
        borderView.backgroundColor = [UIColor colorWithRed:arc4random()%255/255.0 green:arc4random()%255/255.0 blue:arc4random()%255/255.0 alpha:1];
